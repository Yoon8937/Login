...
public class LoginMain extends AppCompatActivity {
    ...
    public void take_an_image(){
        ...
        if (ContextCompat.checkSelfPermission(LoginMain.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(LoginMain.this, new String[]{
    ...
    private void uploadphoto(Bitmap captureImage) {
        ...
        Retrofit retrofit = new Retrofit.Builder().baseUrl(Api.DJANGO_SITE).addConverterFactory(GsonConverterFactory.create()).build();
